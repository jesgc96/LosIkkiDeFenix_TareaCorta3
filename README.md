...
🧠 ¿Cómo funciona?
La aplicación inicia con Expo
Se ejecuta automáticamente el hook useEffect
Se realiza una solicitud a la API (fetch)
Se reciben los datos en formato JSON
Se procesan los datos
Se muestran en pantalla usando FlatList
